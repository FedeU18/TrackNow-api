...
export interface ApiEstadoUsuarioEstadoUsuario
  extends Struct.CollectionTypeSchema {
  collectionName: 'estado_usuarios';
  info: {
    displayName: 'EstadoUsuario';
    pluralName: 'estado-usuarios';
    singularName: 'estado-usuario';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::estado-usuario.estado-usuario'
    >;
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiNotificacionNotificacion
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    tipo_notificacion: Schema.Attribute.Relation<
      'manyToOne',
      'api::tipo-notificacion.tipo-notificacion'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    calificacion: Schema.Attribute.Relation<
      'oneToOne',
      'api::valoracion.valoracion'
    >;
    cliente: Schema.Attribute.Relation<'manyToOne', 'api::usuario.usuario'>;
    codigoPedido: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado_pedido: Schema.Attribute.Relation<
      'manyToOne',
      'api::estado-pedido.estado-pedido'
    >;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    repartidor: Schema.Attribute.Relation<'manyToOne', 'api::usuario.usuario'>;
    ubicacions: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTipoNotificacionTipoNotificacion
  extends Struct.CollectionTypeSchema {
  collectionName: 'tipo_notificacions';
  info: {
    displayName: 'TipoNotificacion';
    pluralName: 'tipo-notificacions';
    singularName: 'tipo-notificacion';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTipoUbicacionTipoUbicacion
  extends Struct.CollectionTypeSchema {
  collectionName: 'tipo_ubicacions';
  info: {
    displayName: 'TipoUbicacion';
    pluralName: 'tipo-ubicacions';
    singularName: 'tipo-ubicacion';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::tipo-ubicacion.tipo-ubicacion'
    >;
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiUbicacionUbicacion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pedido: Schema.Attribute.Relation<'manyToOne', 'api::pedido.pedido'>;
    publishedAt: Schema.Attribute.DateTime;
    tipo_ubicacion: Schema.Attribute.Relation<
      'manyToOne',
      'api::tipo-ubicacion.tipo-ubicacion'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiUsuarioUsuario extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documento: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    estado_usuario: Schema.Attribute.Relation<
      'manyToOne',
      'api::estado-usuario.estado-usuario'
    >;
    locale: Schema.Attribute.String;
    ...
    >;
    pedidos: Schema.Attribute.Relation<'oneToMany', 'api::pedido.pedido'>;
    pedidosAsignados: Schema.Attribute.Relation<
      'oneToMany',
      'api::pedido.pedido'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::estado-usuario.estado-usuario': ApiEstadoUsuarioEstadoUsuario;
      'api::notificacion.notificacion': ApiNotificacionNotificacion;
      'api::pedido.pedido': ApiPedidoPedido;
      'api::rol.rol': ApiRolRol;
      'api::tipo-notificacion.tipo-notificacion': ApiTipoNotificacionTipoNotificacion;
      'api::tipo-ubicacion.tipo-ubicacion': ApiTipoUbicacionTipoUbicacion;
